...
const MapSvg: React.FC<SvgComponentProps> = ({ roomArray, selectedRoom, setSelectedRoom }) => {
    ...
    return (
        ...
        font-size:22.1902px
            ...
            />
            <path id="1-2-12" className="st1 selected" d="M753.5 68.5H848.5V141.5H753.5z" onClick={handleClick} />
